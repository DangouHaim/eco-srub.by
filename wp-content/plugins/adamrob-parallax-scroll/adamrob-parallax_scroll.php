...
function adamrob_parallax_scroll_scripts(){
    ...
    wp_register_script( 'parallax-script', plugins_url( '/includes/parallax/parallax.min.js', __FILE__ ), array('jquery'), true );
    wp_register_script( 'parallax-script-fullwidth', plugins_url( '/includes/js/fullwidth.js', __FILE__ ), array('jquery'), true );
    wp_register_script( 'parallax-script-scroll', plugins_url( '/includes/js/scroll.js', __FILE__ ), array('jquery'), true );
}
