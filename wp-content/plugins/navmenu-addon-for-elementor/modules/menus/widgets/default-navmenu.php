	...
	protected function render() {
		...
		?>
			...
			<div id="elementor-menu" class="elementor-menu">
				...
				<nav itemtype="https://schema.org/SiteNavigationElement" itemscope="itemscope" id="elementor-navigation" class="elementor-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Elementor Menu', 'navmenu-addon-for-elementor' ); ?>">				
				<?php
					wp_nav_menu(
						apply_filters(
