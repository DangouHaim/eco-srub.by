...
class AXPluginCore extends AxPluginBase {
	...
	public function adminEnqueueScriptsHandler(){		
		...
		if($screenID==AX_PORTFOLIO_SLUG){
			...
			wp_register_script( 'portfolio_options_script', AXP_JS_ADMIN.'/rx_portfolio_admin.js', array('jquery'), '', true);			 
		...
		if($screenID==AX_PORTFOLIO_SLUG.'_page_rx_portfolio_sett'){
			...
			wp_register_script('rx_admin_bootstrap_js', AX_TEMPPATH.'/com/riaextended/bootstrap_3_0/js/bootstrap.min.js', array('jquery'), '', true);
			wp_enqueue_script('rx_admin_bootstrap_js');
			
			wp_register_script('rx_options_page_script', AX_TEMPPATH.'/com/riaextended/js'.'/admin_pages/rx_options.js', '', '', true);
	...
	public function WPEnqueueScriptsHandler(){
		...
		wp_register_script('rx-bootstrap-js', AX_TEMPPATH.'/bootstrap_3_0/js/bootstrap.min.js', array('jquery'), '', true);			 
		...
		//backstretch js
		wp_register_script('backstretch-js', AX_TEMPPATH.'/js/external/backstretch.js', array('jquery'), '', true);
		wp_enqueue_script('backstretch-js');			
							
		wp_register_script('rx-portfolio-js', AX_TEMPPATH.'/js/aeolus_portfolio.js', array('jquery'), '', true);			 
